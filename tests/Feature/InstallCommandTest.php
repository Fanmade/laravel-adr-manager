...
afterEach(function () {
    ...
    $files->deleteDirectory(app_path('Livewire'));
...
it('installs the livewire starter stack', function () {
    ...
    expect(file_exists(app_path('Livewire/Adr/AdrIndex.php')))->toBeTrue()
        ->and(file_exists(resource_path('views/vendor/adr-manager/adr-index.blade.php')))->toBeTrue();
});
